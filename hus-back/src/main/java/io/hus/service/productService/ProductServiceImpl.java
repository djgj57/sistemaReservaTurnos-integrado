...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<Product> getProductByPages(Integer page, Integer size) {
    log.info("Getting product by pages: " + page);

        Pageable xPageWithYElements = PageRequest.of(page, size);
        List<Product> products =
                productRepository.findBy(xPageWithYElements);
